    ...
    public sealed partial class HumanoidCharacterProfile : ICharacterProfile
    {
        ...
        private HumanoidCharacterProfile(
            ...
            : this(other.Name, other.FlavorText, other.Species, other.Height, other.Age, other.Sex, other.Gender, other.BankBalance, other.Appearance, other.Clothing, other.Backpack, other.SpawnPriority,
                jobPriorities, other.PreferenceUnavailable, antagPreferences, traitPreferences, other.CDCharacterRecords, loadouts)
        {
        }
        ...
        public HumanoidCharacterProfile(
            ...
            : this(name, flavortext, species, height, age, sex, gender, bankBalance, appearance, clothing, backpack, spawnPriority, new Dictionary<string, JobPriority>(jobPriorities),
                preferenceUnavailable, new List<string>(antagPreferences), new List<string>(traitPreferences), cdCharacterRecords, new Dictionary<string, RoleLoadout>(loadouts))
        {
        }
        ...
        public static HumanoidCharacterProfile RandomWithSpecies(string species = SharedHumanoidAppearanceSystem.DefaultSpecies, int balance = DefaultBalance)
        {
            ...
            return new HumanoidCharacterProfile(name, "", species, height, age, sex, gender, balance, HumanoidCharacterAppearance.Random(species, sex), SpawnPriorityPreference.None,
                new Dictionary<string, JobPriority>
                {
                    {SharedGameTicker.FallbackOverflowJob, JobPriority.High},
                }, PreferenceUnavailableMode.StayInLobby, new List<string>(), new List<string>(), null, new Dictionary<string, RoleLoadout>());
        }
